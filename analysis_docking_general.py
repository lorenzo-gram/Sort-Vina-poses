...
pose_inicial=input("Cual es la primera pose que considerar?\t")   #the user defines the first pose to analyse (they're already ordered by energy)
pose_final=input("Cual es la ultima pose que considerar?\t") #the user defines the last pose to analyse (they're already ordered by energy)
